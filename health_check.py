...
REQUIRED_FILES = [
    ...
    "parsing/backfill_worker.py",
    "parsing/worker_manager.py",

    "dialogs/__init__.py",
    "dialogs/backfill_dialog.py",
...
MODULE_SYMBOLS = {
    ...
    "core.title_rules": ["apply_title_rules", "get_body_prefix_text"],
    "core.shell_utils": ["show_file_in_explorer"],
    ...
    "parsing.backfill_worker": ["BackfillWorker"],
    ...
    "dialogs.statistics_dialog": ["StatisticsDialog"],
